...
func (r *swapRequestRepository) GetIncomingSwapRequests(ctx context.Context, responderUserID int64) ([]db.SwapRequest, error) {
	return r.queries.GetIncomingSwapRequests(ctx, responderUserID)
}

func (r *swapRequestRepository) GetOutgoingSwapRequests(ctx context.Context, requesterUserID int64) ([]db.SwapRequest, error) {
